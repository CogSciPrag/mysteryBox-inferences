...
check_controls(degano2024_processed) #%>% count(better_metric)
check_controls(marty2023_processed)  #%>% count(better_metric)
check_controls(marty2022_processed) #%>% count(better_metric)
```
...
* Degano et al 2024: 
  ...
  * E3: top 3 models: text-davinci-003, Llama-2-70b-hf, Llama-2-13b-hf
* Marty et al 2023: 
  * E1: top 3 models: text-davinci-003, Llama-2-70b-hf,	Llama-2-7b-chat-hf or Llama-2-13b-hf (tie)
  * E2: top 3 models: text-davinci-003, Llama-2-70b-hf, Llama-2-13b-hf
* Marty et al 2022: 
  * E4: top 3 models: text-davinci-003, Llama-2-70b-hf
  * E5: top 3 models: text-davinci-003, Llama-2-70b-hf
...
degano_filtered <- degano2024_processed %>%
  filter(((Experiment == "Exp_1") & (model == "text-davinci-003")) | 
           ((model == "Llama-2-70b-hf")) |
           ((model == "Llama-2-13b-hf")) |
           ((Experiment == "Exp_2") & (model == "Llama-2-7b-hf")) | 
...
marty2022_filtered <- marty2022_processed %>%
  filter(((Experiment == "Exp_6") & (model == "Llama-2-7b-chat-hf")) | 
           ((model == "Llama-2-70b-hf")) |
           ((model == "text-davinci-003"))  
           ) %>% select(-norm_factor, -prob_good, -prob_bad, -chosen_response_llh)
